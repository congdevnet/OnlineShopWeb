...
namespace WebBanHangMcv.Models
{
    public interface IRepository : IDisposable
    {
        ...
        //IQueryable<TEntity> FilterPaged<TEntity>(PagingParams1<TEntity> pagingParams)
        //    where TEntity : class;

        //IQueryable<TEntity> FilterPaged<TEntity>(out int total, PagingParams1<TEntity> pagingParams)
        //    where TEntity : class;

        //PagingResult<TEntity> GetPaged<TEntity>(PagingParams1<TEntity> pagingParams)
        //    where TEntity : class;
